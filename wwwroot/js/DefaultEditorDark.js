const projectID = window.location.search.split('id=')[1] || 0;
const host = 'https://techsitekw.com/';
...
const editor = grapesjs.init({
    ...
    assetManager: {
        assets: [
            `${host}DefaultEditor/img/grapesjs-logo.png`,
            `${host}DefaultEditor/img/tmp-blocks.jpg`,
            `${host}DefaultEditor/img/tmp-tgl-images.jpg`,
            `${host}DefaultEditor/img/tmp-send-test.jpg`,
            `${host}DefaultEditor/img/tmp-devices.jpg`,
        ],
        upload: false,
...
editor.BlockManager.add('T1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t2.png">',
    }
);
editor.BlockManager.add('T2',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t1.png">',
    }
);
editor.BlockManager.add('T3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t3.png">',
    }
);
editor.BlockManager.add('T4',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t4.png">',
    }
);
editor.BlockManager.add('T5',
    {
        ...
        content: `<section class="fdb-block py-5">
              <div class="container py-5" style="background-image: url(../fraola/imgs/shapes/2.svg);">
                <div class="row align-items-center justify-content-center">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t5.png">',
    }
);
editor.BlockManager.add('T6',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t6.png">',
    }
);
editor.BlockManager.add('T7',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t7.png">',
    }
);
editor.BlockManager.add('T8',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t8.png">',
    }
);
editor.BlockManager.add('T9',
    {
        ...
        category: 'Testimonial',
        content: `<section class="fdb-block" style="background-image: url(../fraola/imgs/shapes/9.svg);">
              <div class="container">
                <div class="row text-center justify-content-center">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t9.png">',
    }
);
editor.BlockManager.add('T10',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/t10.png">',
    }
);
...
editor.BlockManager.add('TM1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm1.png">',
    }
);
editor.BlockManager.add('TM2',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm2.png">',
    }
);
editor.BlockManager.add('TM3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm3.png">',
    }
);
editor.BlockManager.add('TM4',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm4.png">',
    }
);
editor.BlockManager.add('TM5',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm5.png">',
    }
);
editor.BlockManager.add('TM6',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm6.png">',
    }
);
editor.BlockManager.add('TM7',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm7.png">',
    }
);
editor.BlockManager.add('TM8',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/tm8.png">',
    }
);
...
editor.BlockManager.add('P1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp1.png">',
    }
);
editor.BlockManager.add('P2',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp2.png">',
    }
);
editor.BlockManager.add('P3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp3.png">',
    }
);
editor.BlockManager.add('P4',
    {
        ...
        content: `<section class="fdb-block py-0">
              <div class="container pt-5 my-5" style="background-image: url(../fraola/imgs/shapes/2.svg)">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp4.png">',
    }
);
editor.BlockManager.add('P5',
    {
        // label: '<b>Pricing 5</b>',
        category: 'Pricing',
        content: `<section class="fdb-block" style="background-image: url(../fraola/imgs/shapes/8.svg);">
              <div class="container">
                <div class="row text-center">
                  <div class="col">
                    <h1>Pricing Plans</h1>
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp5.png">',
    }
);
editor.BlockManager.add('P6',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp6.png">',
    }
);
editor.BlockManager.add('P7',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp7.png">',
    }
);
editor.BlockManager.add('P8',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp8.png">',
    }
);
editor.BlockManager.add('P9',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp9.png">',
    }
);
editor.BlockManager.add('P10',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/pp10.png">',
    }
);
...
editor.BlockManager.add('CO1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co1.png">',
    }
);
editor.BlockManager.add('CO2',
    {
        // label: '<b>Contact 2</b>',
        category: 'contacts',
        content: `<section class="fdb-block bg-dark" style="background-image: url(../fraola/imgs/hero/blue.svg);">
              <div class="container">
                <div class="row text-center justify-content-center">
            ...
            `,
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co2.png">',
    }
);
editor.BlockManager.add('CO3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co3.png">',
    }
);
editor.BlockManager.add('CO4',
    {
        ...
        category: 'contacts',
        content: `<section class="fdb-block py-0">
              <div class="container py-5 my-5" style="background-image: url(../fraola/imgs/shapes/9.svg);">
                <div class="row py-5">
                  <div class="col py-5">
                    <div class="fdb-box fdb-touch">
                      <div class="row text-center justify-content-center">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co4.png">',
    }
);
editor.BlockManager.add('CO5',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co5.png">',
    }
);
...
editor.BlockManager.add('CO7',
    {
        ...
        category: 'contacts',
        content: `<section class="fdb-block py-0">
              <div class="container py-5" style="background-image: url(../fraola/imgs/shapes/6.svg);">
                <div class="row text-center justify-content-center">
                  <div class="col-12 col-md-8 col-lg-7">
                    <h1>Contact Us</h1>
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co7.png">',
    }
);
editor.BlockManager.add('CO8',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co8.png">',
    }
);
editor.BlockManager.add('CO9',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co9.png">',
    }
);
editor.BlockManager.add('CO10',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/co10.png">',
    }
);
...
editor.BlockManager.add('FF1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff1.png">',
    }
);
editor.BlockManager.add('FF2',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff2.png">',
    }
);
editor.BlockManager.add('FF3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff3.png">',
    }
);
editor.BlockManager.add('FF4',
    {
        // label: '<b>Feature 4</b>',
        category: 'Features',
        content: ` <section class="fdb-block bg-dark" style="background-image: url(../fraola/imgs/hero/purple.svg);">
              <div class="container">
                <div class="row">
                  <div class="col text-center">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff4.png">',
    }
);
editor.BlockManager.add('FF5',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff5.png">',
    }
);
editor.BlockManager.add('FF6',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff6.png">',
    }
);
editor.BlockManager.add('FF7',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff7.png">',
    }
);
editor.BlockManager.add('FF8',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff8.png">',
    }
);
editor.BlockManager.add('FF9',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff9.png">',
    }
);
editor.BlockManager.add('FF10',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff10.png">',
    }
);
editor.BlockManager.add('FF11',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff11.png">',
    }
);
editor.BlockManager.add('FF12',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff12.png">',
    }
);
editor.BlockManager.add('FF13',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff13.png">',
    }
);
editor.BlockManager.add('FF14',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff14.png">',
    }
);
editor.BlockManager.add('FF15',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff15.png">',
    }
);
editor.BlockManager.add('FF16',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff16.png">',
    }
);
editor.BlockManager.add('FF17',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff17.png">',
    }
);
editor.BlockManager.add('FF18',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff18.png">',
    }
);
editor.BlockManager.add('FF19',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff19.png">',
    }
);
editor.BlockManager.add('FF20',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff20.png">',
    }
);
editor.BlockManager.add('FF21',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff21.png">',
    }
);
editor.BlockManager.add('FF22',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff22.png">',
    }
);
editor.BlockManager.add('FF23',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff23.png">',
    }
);
editor.BlockManager.add('FF24',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff24.png">',
    }
);
editor.BlockManager.add('FF25',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff25.png">',
    }
);
editor.BlockManager.add('FF26',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff26.png">',
    }
);
editor.BlockManager.add('FF27',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff27.png">',
    }
);
editor.BlockManager.add('FF28',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff28.png">',
    }
);
editor.BlockManager.add('FF29',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff29.png">',
    }
);
editor.BlockManager.add('FF30',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff30.png">',
    }
);
editor.BlockManager.add('FF31',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff31.png">',
    }
);
editor.BlockManager.add('FF32',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/ff32.png">',
    }
);
...
editor.BlockManager.add('FO1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo1.png">',
    }
);
editor.BlockManager.add('FO2',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo2.png">',
    }
);
editor.BlockManager.add('FO3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo3.png">',
    }
);
editor.BlockManager.add('FO4',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo4.png">',
    }
);
editor.BlockManager.add('FO5',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo5.png">',
    }
);
editor.BlockManager.add('FO6',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo6.png">',
    }
);
editor.BlockManager.add('FO7',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo7.png">',
    }
);
editor.BlockManager.add('FO8',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo8.png">',
    }
);
editor.BlockManager.add('FO9',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo9.png">',
    }
);
editor.BlockManager.add('FO10',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo10.png">',
    }
);
editor.BlockManager.add('FO11',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo11.png">',
    }
);
editor.BlockManager.add('FO12',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/fo12.png">',
    }
);
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f1.png">',
//    }
//);
...
//        // label: '<b>Form 5</b>',
//        category: 'Forms',
//        content: `<section class="fdb-block" style="background-image: url(../fraola/imgs/hero/blue.svg);">
//              <div class="container">
//                <div class="fdb-box">
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f2.png">',
//    }
//);
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f3.png">',
//    }
//);
...
//        category: 'Forms',
//        content: `<section class="fdb-block py-0">
//              <div class="container py-5 my-5" style="background-image: url(../fraola/imgs/shapes/6.svg);">
//                <div class="row">
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f4.png">',
//    }
//);
...
//        category: 'Forms',
//        content: `<section class="fdb-block py-0">
//              <div class="container py-5 my-5" style="background-image: url(../fraola/imgs/shapes/4.svg);">
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f5.png">',
//    }
//);
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f6.png">',
//    }
//);
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f7.png">',
//    }
//);
//editor.BlockManager.add('F11',
//    {
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f8.png">',
//    }
//);
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f9.png">',
//    }
//);
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f10.png">',
//    }
//);
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f11.png">',
//    }
//);
...
//        // label: '<b>Form 15</b>',
//        category: 'Forms',
//        content: `<section class="fdb-block" style="background-image: url(../fraola/imgs/shapes/1.svg);">
//              <div class="container">
//                <div class="row justify-content-end">
...
//              </div>
//            </section>`,
//        media: '<img width="100%"  src="../fraola/imgs/thumbnail/f12.png">',
//    }
//);
...
editor.BlockManager.add('H1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/1.jpg">',
    }
);
editor.BlockManager.add('H2',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/2.jpg">',
    }
);
editor.BlockManager.add('H3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/3.jpg">',
    }
);
editor.BlockManager.add('H4',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/4.jpg">',
    }
);
editor.BlockManager.add('H5',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/5.jpg">',
    }
...
editor.BlockManager.add('H6',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/6.jpg">',
    }
);
editor.BlockManager.add('H7',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/7.jpg">',
    }
);
editor.BlockManager.add('H8',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/8.jpg">',
    }
);
editor.BlockManager.add('H9',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/9.jpg">',
    }
);
editor.BlockManager.add('H10',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/10.jpg">',
    }
);
editor.BlockManager.add('H11',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/11.jpg">',
    }
);
editor.BlockManager.add('H12',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/12.jpg">',
    }
);
editor.BlockManager.add('H13',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/13.jpg">',
    }
);
editor.BlockManager.add('H14',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/14.jpg">',
    }
);
editor.BlockManager.add('H15',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/15.jpg">',
    }
);
editor.BlockManager.add('H16',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/16.jpg">',
    }
);
editor.BlockManager.add('H17',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/17.jpg">',
    }
);
editor.BlockManager.add('H18',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/18.jpg">',
    }
);
editor.BlockManager.add('H19',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/19.jpg">',
    }
);
editor.BlockManager.add('H20',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/20.jpg">',
    }
);
...
editor.BlockManager.add('CTA1',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta1.png">',
    }
);
editor.BlockManager.add('CTA2',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta2.png">',
    }
);
editor.BlockManager.add('CTA3',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta3.png">',
    }
);
editor.BlockManager.add('CTA4',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta4.png">',
    }
);
editor.BlockManager.add('CTA5',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta5.png">',
    }
);
editor.BlockManager.add('CTA6',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta6.png">',
    }
);
editor.BlockManager.add('CTA7',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta7.png">',
    }
);
editor.BlockManager.add('CTA8',
    {
        ...
        category: 'Call To Action',
        content: `<section class="fdb-block py-0">
              <div class="container py-5 my-5" style="background-image: url(../fraola/imgs/shapes/2.svg);">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta8.png">',
    }
);
editor.BlockManager.add('CTA9',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta9.png">',
    }
);
editor.BlockManager.add('CTA10',
    {
        ...
        category: 'Call To Action',
        content: `<section class="fdb-block py-0">
              <div class="container py-5 my-5 bg-r" style="background-image: url(../fraola/imgs/shapes/4.svg);">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta10.png">',
    }
);
editor.BlockManager.add('CTA11',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta11.png">',
    }
);
editor.BlockManager.add('CTA12',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta12.png">',
    }
);
editor.BlockManager.add('CTA13',
    {
        // label: '<b>CTA 13</b>',
        category: 'Call To Action',
        content: `<section class="fdb-block fdb-viewport bg-dark" style="background-image: url(../fraola/imgs/hero/purple.svg);">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta13.png">',
    }
);
editor.BlockManager.add('CTA14',
    {
        ...
        category: 'Call To Action',
        content: `<section class="fdb-block py-0">
              <div class="container bg-r py-5 my-5" style="background-image: url(../fraola/imgs/shapes/1.svg);">
                <div class="row py-5">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta14.png">',
    }
);
editor.BlockManager.add('CTA15',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta15.png">',
    }
);
editor.BlockManager.add('CTA16',
    {
        // label: '<b>CTA 16</b>',
        category: 'Call To Action',
        content: `<section class="fdb-block bg-dark fdb-viewport" style="background-image: url(../fraola/imgs/hero/blue.svg);">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta16.png">',
    }
);
editor.BlockManager.add('CTA17',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta17.png">',
    }
);
editor.BlockManager.add('CTA18',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta18.png">',
    }
);
editor.BlockManager.add('CTA19',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta19.png">',
    }
);
editor.BlockManager.add('CTA20',
    {
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta20.png">',
    }
);
editor.BlockManager.add('CTA21',
    {
        // label: '<b>CTA 21</b>',
        category: 'Call To Action',
        content: ` <section class="fdb-block fdb-viewport bg-dark" style="background-image: url(../fraola/imgs/hero/red.svg);">
              <div class="container align-items-center justify-content-center d-flex">
                <div class="row align-items-center text-left">
        ...
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta21.png">',
    }
);
editor.BlockManager.add('CTA22',
    {
        ...
        content: `<section class="fdb-block">
            ...
            `,
        media: '<img width="100%"  src="../fraola/imgs/thumbnail/cta22.png">',
    }
);
...
document.addEventListener("DOMContentLoaded", function () {
    // Find the clear canvas button element
    var clearCanvasButton = document.querySelector('.gjs-pn-btn[data-tooltip="Clear canvas"]');

    // Check if the button element exists
    if (clearCanvasButton) {

        // You can also update the data-tooltip attribute if needed
        clearCanvasButton.setAttribute('data-tooltip', 'Clear Page');
    }

    // Remove unwanted elements
    var elementsToRemove = document.querySelectorAll(".gjs-pn-btn[data-tooltip='View code'], .gjs-pn-btn[data-tooltip='Toggle images'], .gjs-pn-btn[data-tooltip='Import']");
...
function ProjectData() {
    //let PagesList = document.getElementById("PagesDrowpDown");
    ...
    for (let i = 0; i < projectDataPages.length; i++) {
        ...
        option.innerHTML = ` <a class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2" onclick="getPage(this.id)" id="${projectDataPages[i].id}">
                            ${projectDataPages[i].id}
                        </a>
                    ...
                    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" onclick="DeletePage(this.id)" id="${projectDataPages[i].id}">
                        <i class="ki-duotone ki-trash fs-2"><span class="path1"></span><span class2"></span><span class3"></span><span class4"></span><span class5"></span></i>
                    </a>`
        ...
        //            <div class="ms-5">
        //                <a class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2" onclick="getPage(this.id)" id="${projectDataPages[i].id}">
        //                    ${projectDataPages[i].id}
        //                </a>
        //                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" onclick="EditPage(this.id)" id="${projectDataPages[i].id}">
        //                <i class="ki-duotone ki-pencil fs-2"><span class="path1"></span><span class="path2"></span></i>
...
function getPage(pagename) {
    ...
    PageOptions(pagename);
}

function PageOptions(pagename) {
    let projectData = editor.getProjectData();
    let projectDataPages = projectData.pages;
    let PagesList = document.getElementById("Pages");
    for (let i = 0; i < projectDataPages.length; i++) {
        if (projectDataPages[i].id == pagename) {
            if (projectDataPages[i].id.toUpperCase() == "INDEX") {
                PagesList.innerHTML = ``;
            } else {
                ...
                PagesList.innerHTML = `
                    <div class="d-flex flex-stack py-4">
                        <div class="d-flex align-items-center">
                            <div class="ms-5">
                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" onclick="EditPage(this.id)">
                                    <i class="ki-duotone ki-pencil fs-2"><span class="path1"></span><span class="path2"></span></i>
                                </a>
                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" onclick="DeletePage(this.id)">
...
const planId = document.getElementById("planSiteId").textContent.trim();

document.getElementById("PagesDrowpDown").addEventListener("change", function () {
    getPage(this.value);
});
...
async function AddPostPage() {
    ...
    let projectData = await editor.getProjectData();
    ...
    if (PageName.value == "") {
        ...
        if (projectDataPagesToUpper.includes(PageName.value.toUpperCase())) {
            ...
            console.log(newPage);
            // Update the project data with the new page
            ...
            console.log("wndo reload after add page");
            window.location.href = "DefaultEditorDark?id=" + projectID;
