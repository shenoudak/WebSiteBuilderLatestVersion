...
async function initializePage() {
    var elementToRemove = document.querySelector('.gjs-pn-btn.fa.fa-code');
    if (elementToRemove) {
        elementToRemove.parentNode.removeChild(elementToRemove);
    }


    var customOptionsPanel = document.querySelector('.gjs-pn-panel.gjs-pn-options.gjs-one-bg.gjs-two-color');
    var elementToAdd = document.querySelector('.gjs-pn-buttons');
    if (customOptionsPanel && elementToAdd) {
        var customCodeAdd = `
                                    <div class="d-flex gap-2" style="padding-right:110px">
                            <a id="undo" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="@sharedResource["Undo"]">
                             ...
                             <span class="path5"></span>
                                ...
                                `;
        elementToAdd.innerHTML += customCodeAdd;
    ...
    var defaultDevicePanel = document.querySelector('.gjs-devices-c');
    console.log("devicesToremove", document.querySelector('.gjs-devices-c'));
    var customDevicePanel = document.querySelector('.gjs-pn-panel.gjs-pn-devices-c.gjs-one-bg.gjs-two-color');
    console.log("devicesToadded in", document.querySelector('.gjs-pn-panel.gjs-pn-devices-c.gjs-one-bg.gjs-two-color'));

    if (defaultDevicePanel && customDevicePanel) {
        var customCode = `
                                            ...
                                            margin-left: 20px;">
                                                                <ul class="nav" role="tablist">
                                                                    ...
                                                                    <li class="nav-item" role="presentation">
                                                                        <a id="btnDeviceTablet" class="nav-link btn btn-icon btn-color-muted btn-active-color-primary btn-active-light fw-semibold fs-7 px-4 me-1 " data-bs-toggle="tab" href="#" aria-selected="false" role="tab" tabindex="-1">
                                                                    ...
                                                                    <li class="nav-item" role="presentation">
                                                                        <a id="btnDeviceDesktop" class="nav-link btn btn-icon btn-color-muted btn-active-color-primary btn-active-light fw-semibold fs-7 px-4 me-1 " data-bs-toggle="tab" href="#" aria-selected="false" role="tab" tabindex="-1">
        ...
        defaultDevicePanel.remove();
        customDevicePanel.innerHTML += customCode;
        ...
        document.getElementById("btnDeviceMobile").addEventListener('click', event => { console.log("mobile"); editor.setDevice("mobile"); });
    }
