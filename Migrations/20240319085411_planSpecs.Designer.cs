...
namespace iTech.Migrations
{
    ...
    [Migration("20240319085411_planSpecs")]
    partial class planSpecs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iTech.Models.AffilateFeedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AffilateFeedbackId = 1,
                            TitleAr = "الاي تيك هي شركة النجاح",
                            TitleEn = "Itech Is Successfull Company",
                            UserOneFeedbackAr = "لقد ساعدتني الاي تيك كثرا في بناء حياتي ....اسلام احمد",
                            UserOneFeedbackEn = "Itech Help Me To Build My Live ....Eslam Ahmed",
                            UserThreeFeedbackAr = "لقد ساعدتني الاي تيك كثرا في بناء حياتي ....اسلام احمد",
                            UserThreeFeedbackEn = "Itech Help Me To Build My Live ....Eslam Ahmed",
                            UserTwoFeedbackAr = "لقد ساعدتني الاي تيك كثرا في بناء حياتي ....اسلام احمد",
                            UserTwoFeedbackEn = "Itech Help Me To Build My Live ....Eslam Ahmed"
                        });
                });
            ...
            modelBuilder.Entity("iTech.Models.CountDownSection", b =>
                {
                    b.Property<int>("CountDownSectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CountDownSectionId"));
                    ...
                    b.HasKey("CountDownSectionId");

                    b.ToTable("CountDownSections");

                    b.HasData(
                        new
                        {
                            CountDownSectionId = 1,
                            CountDown = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TextAR = "قسم العد التنازلي",
                            TextEN = "countdown section"
                        });
                });
            ...
            modelBuilder.Entity("iTech.Models.Feature", b =>
                {
            ...
            modelBuilder.Entity("iTech.Models.PaymentMethod", b =>
                {
            ...
            modelBuilder.Entity("iTech.Models.PlanSpecs", b =>
                {
                    b.Property<int>("PlanSpecsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PlanSpecsId"));
                    ...
                    b.HasKey("PlanSpecsId");

                    b.HasIndex("PlanId");

                    b.ToTable("PlansSpecs");
                });
            ...
            modelBuilder.Entity("iTech.Models.SiteModificationRequest", b =>
                {
                    b.Property<long>("SMReqId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("SMReqId"));
                    ...
                    b.Property<int?>("WESubscriptionId")
                        .HasColumnType("int");

                    b.Property<int?>("WESubscriptionsWESubscriptionId")
                        .HasColumnType("int");

                    b.HasKey("SMReqId");

                    b.HasIndex("WESubscriptionsWESubscriptionId");

                    b.ToTable("SiteModificationRequests");
                });
            ...
            modelBuilder.Entity("iTech.Models.SiteSubscription", b =>
                {
                    b.Property<int>("SiteSubscriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SiteSubscriptionId"));
            ...
            modelBuilder.Entity("iTech.Models.WebEditorPlan", b =>
                {
                    b.Property<int>("WebEditorPlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WebEditorPlanId"));
                    ...
                    b.HasKey("WebEditorPlanId");

                    b.ToTable("WebEditorPlans");
                });

            modelBuilder.Entity("iTech.Models.WebEditorSubscription", b =>
                {
                    b.Property<int>("WESubscriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WESubscriptionId"));
                    ...
                    b.HasKey("WESubscriptionId");

                    b.HasIndex("PlanId");

                    b.HasIndex("SiteId");

                    b.ToTable("WebEditorSubscriptions");
                });
            ...
            modelBuilder.Entity("iTech.Models.PlanSpecs", b =>
                {
                    b.HasOne("iTech.Models.WebEditorPlan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("iTech.Models.SiteModificationRequest", b =>
                {
                    b.HasOne("iTech.Models.WebEditorSubscription", "WESubscriptions")
                        .WithMany("SiteModificationRequests")
                        .HasForeignKey("WESubscriptionsWESubscriptionId");

                    b.Navigation("WESubscriptions");
                });
            ...
            modelBuilder.Entity("iTech.Models.SiteSubscription", b =>
                {
                    b.HasOne("iTech.Models.Plan", "Plan")
                        .WithMany()
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iTech.Models.Site", "Site")
                        .WithMany()
                        .HasForeignKey("SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iTech.Models.WebEditorSubscription", b =>
                {
                    b.Navigation("SiteModificationRequests");
                });
