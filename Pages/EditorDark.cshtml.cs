...
{
    public class EditorDarkModel : PageModel
    {
        ...
        public EditorDarkModel(CRMDBContext context, IWebHostEnvironment hostEnvironment, UserManager<ApplicationUser> userManager)
        {
            _context = context;
